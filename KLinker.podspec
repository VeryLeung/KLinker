#
#  Be sure to run `pod spec lint KLinker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Very" => "liang.yellow@gmail.com" }
  # Or just: s.author    = "Very"
  # s.authors            = { "Very" => "liang.yellow@gmail.com" }
  # s.social_media_url   = "http://twitter.com/VeryLeung"
  ...
  s.source       = { :git => "https://github.com/VeryLeung/KLinker.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "KLinker","KLinker/**/*.{h,m}"
